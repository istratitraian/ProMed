;(function (m, oa) {
    ...
    function Yb(a, b, e) {
        ...
        b.droppable && m(document).bind("dragstart", function (k, D) {
            ...
            console.log('m.droppable k = '+k.target.className+', D = '+ D);
            ...
            if (!ja.parents(".fc").length) {
               ...
               console.log('m.dragstop k = '+k.target+', D = '+ D);
            if (M) {
                n.dragStop(M, k, D);
                M = null;
            }
            ...
            (u = b.header[u]) && m.each(u.split(" "), function (na) {
                ...
                m.each(this.split(","), function (ra, sa) {
                    if (sa === "title") {
                        ...
                        if (ha) {
                            ra = b.theme ? jb(b.btnIcons, sa) : null;
                            var da = jb(b.btnTxt, sa),
                                    ma = m("<span class='fc-button fc-button-" + sa 
                                    + " " + q + "-state-default'><span class='fc-button-inner'><span class='fc-button-content'>" 
    ...
    var Ya = {defaultView: "month", aspectRatio: 1.35,
        ...
        weekends: true, allDayDefault: true, ignoreTimezone: true,
        lazyFetching: true, startParam: "start",
        endParam: "end", titleFormat: {month: "MMMM yyyy", week: "MMM d[ yyyy]{ '&#8212;'[ MMM] d yyyy}", day: "dddd, MMM d, yyyy"},
        columnFormat: {month: "ddd", week: "ddd M/d", day: "dddd M/d"},
        timeFormat: {"": "h(:mm)t"}, isRTL: false, firstDay: 0,
        monthNames: ["Ianuarie", "Februarie", "Martie", "Aprilie", "Mai", "Iunie", "Iulie", "August", "Septembrie", "Octobmbrie", "Novembrie", "Decembrie"],
        monthNamesShort: ["Ian", "Feb", "Mar", "Apr", "Mai", "Iun", "Iul", "Aug", "Sep", "Oct", "Noe", "Dec"],
        dayNames: ["Duminica", "Luni", "Marti", "Miercuri", "Joi", "Vineri", "Sambata"],
        dayNamesShort: ["Dum", "Lun", "Mar", "Mie", "Joi", "Vin", "Sam"],
        btnTxt: {prev: "", next: "", prevYear: "&nbsp;&lt;&lt;&nbsp;", nextYear: "&nbsp;&gt;&gt;&nbsp;", today: "", month: "month", week: "week", day: "day"},
        theme: false, btnIcons: {prev: "circle-triangle-w", next: "circle-triangle-e"},
        unselectAuto: true, dropAccept: "*"},
            xc = {header: {left: "next,prev today", center: "", right: "title"},
                btnTxt: {prev: "&nbsp;&#9658;&nbsp;", next: "&nbsp;&#9668;&nbsp;",
                    prevYear: "&nbsp;&gt;&gt;&nbsp;", nextYear: "&nbsp;&lt;&lt;&nbsp;"},
                btnIcons: {prev: "circle-triangle-e", next: "circle-triangle-w"}},
...
//    var lc = ["sun", "mon", "tue", "wed", "thu", "fri", "sat"],
    var lc = ["dum", "lun", "mar", "mie", "joi", "vin", "sam"],
            Ab = 864E5, cc = 36E5, wc = 6E4, dc = {s: function (a) {
                    return a.getSeconds();
                }, ss: function (a) {
    ...
    Ja.agendaWeek = qc;
    Ja.agendaDay = rc;
    wb({allDaySlot: true, allDayText: "all-day", firstHour: 6, slotMinutes: 30, defaultEventMinutes: 120, axisFormat: "h(:mm)tt",
        timeFormat: {agenda: "h:mm{ - h:mm}"}, dragOpacity: {agenda: 0.5}, minTime: 0, maxTime: 24});
})(jQuery);
