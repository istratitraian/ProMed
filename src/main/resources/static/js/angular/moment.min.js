...
(function (a) {
    ...
    rc.DDDD = h(rc.DDD, 3), o(l.prototype, {set: function (a) {
        ...
        }, _months: "Ianuarie_Februarie_Martie_Aprilie_Mai_Iunie_Iulie_August_Septembrie_Octombrie_Noembrie_Decembrie".split("_"), months: function (a) {
            return this._months[a.month()]
        }, _monthsShort: "Ian_Feb_Mar_Apr_Mai_Iun_Iul_Aug_Sep_Oct_Noe_Dec".split("_"), monthsShort: function (a) {
        ...
        }, _weekdays: "Duminica_Luni_Marti_Miercuri_Joi_Vineri_Sambata".split("_"), weekdays: function (a) {
            return this._weekdays[a.day()]
        }, _weekdaysShort: "Duminica_Luni_Marti_Miercuri_Joi_Vineri_Sambata".split("_"), weekdaysShort: function (a) {
            return this._weekdaysShort[a.day()]
        }, _weekdaysMin: "Du_Lu_Ma_Mi_Jo_Vi_Sa".split("_"), weekdaysMin: function (a) {
